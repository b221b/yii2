...
use app\modules\admin\models\SportsmanTrainersSearch;
...
class SportsmanTrainersController extends Controller
{
    ...
    {
        $searchModel = new SportsmanTrainersSearch();
    ...
    {
        if (($model = SportsmanTrainers::findOne(['id' => $id])) !== null) {
            return $model;
        }
