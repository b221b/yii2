...
use app\modules\admin\models\SportsmanCompetitionsSearch;
...
class SportsmanCompetitionsController extends Controller
{
    ...
    {
        $searchModel = new SportsmanCompetitionsSearch();
    ...
    {
        $model = new SportsmanCompetitions();
    ...
    {
        if (($model = SportsmanCompetitions::findOne(['id' => $id])) !== null) {
            return $model;
        }
